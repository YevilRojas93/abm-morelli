		  ...
		  <tbody class="fs-5">
		  	<?php 
				...
				if ($_SESSION["tipo"] == "administrador") {
					$sql = Conexion::conectar()->prepare("SELECT a.idAgencia,a.nombre_agencia,a.telefono,a.localidad,a.direccion,u.nombre_completo FROM agencias AS a LEFT JOIN usuarios AS u ON u.idAgencia = a.idAgencia");
				}
				else{
					$sql = Conexion::conectar()->prepare("SELECT a.idAgencia,a.nombre_agencia,a.telefono,a.localidad,a.direccion,u.nombre_completo FROM agencias AS a LEFT JOIN usuarios AS u ON u.idAgencia = a.idAgencia where a.idUsuario = :idUsuario");
				...
				foreach ($lista_agencia as $key => $value):
					?>
					<tr>
				      <th scope="row"><?= $value["idAgencia"]; ?></th>
