			...
			<table class="table border border-4 ">
			  ...
			  <tbody>
			  	...
			  	<?php 
					...
					$sql = Conexion::conectar()->prepare("SELECT c.monto,c.idCobro,a.nombre_agencia as agencia,c.tipo_pago,c.fecha_cobro,c.status FROM cobros as c INNER JOIN agencias as a ON a.idAgencia = c.idAgencia WHERE c.fecha_cobro BETWEEN :fecha_inicio and :fecha_fin $agencia AND c.status = 'pendiente'");
